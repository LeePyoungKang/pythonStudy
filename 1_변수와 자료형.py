...
# github 이름과 이메일 설정
# git config --global use.name "LeePyoungKang"          /이름 설정
# git config --global user.email "vudrkd333@naver.com"          /이메일 설정
# git config --list         /확인
